  ...
  return (
    <Section id="guarantee">
      <div className="text-center">
        ...
        {/* Heading (smaller) */}
        <h2 className="mt-4 text-[clamp(32px,4.5vw,56px)] font-extrabold tracking-[-0.04em] leading-[1.08] text-white/95">
        ...
        {/* Subtext */}
        <p className="mx-auto mt-6 max-w-[780px] text-[16px] leading-[1.7] text-white/72">
